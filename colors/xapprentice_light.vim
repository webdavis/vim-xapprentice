...
if $TERM =~? '256' || &t_Co >= 256 || has('gui_running')
    ...
    highlight Constant         ctermbg=NONE ctermfg=137  guibg=NONE    guifg=#af87d7 | call s:FormatGroup('Constant')
    highlight Number           ctermbg=NONE ctermfg=137  guibg=NONE    guifg=#af87d7 | call s:FormatGroup('Constant')
    highlight Error            ctermbg=131  ctermfg=15   guibg=#ff8787 guifg=#303030 | call s:FormatGroup('Error')
    highlight Identifier       ctermbg=NONE ctermfg=67   guibg=NONE    guifg=#005f87 | call s:FormatGroup('Identifier')
    ...
    highlight Statement        ctermbg=NONE ctermfg=110  guibg=NONE    guifg=#005fd7 | call s:FormatGroup('Statement')
    highlight String           ctermbg=NONE ctermfg=108  guibg=NONE    guifg=#00875f | call s:FormatGroup('String')
    ...
    highlight TabLine          ctermbg=238  ctermfg=101  guibg=#9e9e9e guifg=#585858 | call s:FormatGroup('TabLine')
    ...
    highlight StatusLineNC     ctermbg=238  ctermfg=101  guibg=#9e9e9e guifg=#585858 | call s:FormatGroup('StatusLineNC')

    highlight StatusLineTerm   ctermbg=101  ctermfg=252  guibg=#d0d0d0 guifg=#303030 | call s:FormatGroup('StatusLineTerm')
    highlight StatusLineTermNC ctermbg=238  ctermfg=101  guibg=#9e9e9e guifg=#585858 | call s:FormatGroup('StatusLineTermNC')
