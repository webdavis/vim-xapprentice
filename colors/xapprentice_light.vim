...
if $TERM =~? '256' || &t_Co >= 256 || has('gui_running')
    ...
    highlight TabLine          ctermbg=248  ctermfg=236  guibg=#a8a8a8 guifg=#303030 | call s:FormatGroup('TabLine')
    highlight TabLineFill      ctermbg=249  ctermfg=236  guibg=#b2b2b2 guifg=#303030 | call s:FormatGroup('TabLineFill')
    highlight TabLineSel       ctermbg=110  ctermfg=236  guibg=#87afd7 guifg=#303030 | call s:FormatGroup('TabLineSel')
