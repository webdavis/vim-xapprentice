...
if $TERM =~? '256' || &t_Co >= 256 || has('gui_running')
  ...
  execute 'highlight Pmenu            ctermbg=237  ctermfg=250  guibg='.s:chrome.'     guifg=#bcbcbc'        | call format#FormatHighlightGroup('Pmenu')
           highlight PmenuSbar        ctermbg=240  ctermfg=NONE guibg=#585858          guifg=NONE            | call format#FormatHighlightGroup('PmenuSbar')
  execute 'highlight PmenuSel         ctermbg=248  ctermfg=232  guibg=#a8a8a8          guifg='.s:background  | call format#FormatHighlightGroup('PmenuSel')
           highlight PmenuThumb       ctermbg=245  ctermfg=245  guibg=#8a8a8a          guifg=#8a8a8a         | call format#FormatHighlightGroup('PmenuThumb')
  ...
  execute 'highlight CursorLine       ctermbg=236  ctermfg=NONE guibg='.s:tint.'       guifg=NONE'           | call format#FormatHighlightGroup('CursorLine')
           ...
           highlight StatusLine       ctermbg=238  ctermfg=250  guibg=#444444          guifg=#c6c6c6         | call format#FormatHighlightGroup('StatusLine')
