...
if $TERM =~? '256' || &t_Co >= 256 || has('gui_running')
    ...
    highlight Comment          ctermbg=NONE ctermfg=242  guibg=NONE    guifg=#6c6c6c | call s:FormatGroup('Comment')
    ...
    if exists('g:did_coc_loaded')
        ...
        highlight CocHintSign           ctermbg=234  ctermfg=65   guibg=#1c1c1c guifg=#5f875f | call s:FormatGroup('CocHintSign')
        highlight CocHintVirtualText    ctermbg=NONE ctermfg=65   guibg=NONE    guifg=#5f875f | call s:FormatGroup('CocHintVirtualText')
        highlight CocHintHighlight      ctermbg=65   ctermfg=0    guibg=#5f875f guifg=#000000 | call s:FormatGroup('CocHintHighlight')
        execute 'highlight CocWarningSign ctermbg=234 ctermfg=222 guibg=#1c1c1c guifg=' . s:lightyellow | call s:FormatGroup('CocWarningSign')
        execute 'highlight CocWarningVirtualText ctermbg=NONE ctermfg=222 guibg=NONE guifg=' . s:lightyellow | call s:FormatGroup('CocWarningVirtualText')
        ...
        highlight CocErrorSign          ctermbg=234  ctermfg=95   guibg=#1c1c1c guifg=#875f5f | call s:FormatGroup('CocErrorSign')
        highlight CocErrorVirtualText   ctermbg=NONE ctermfg=95   guibg=NONE    guifg=#875f5f | call s:FormatGroup('CocErrorVirtualText')
    ...
    highlight TabLine          ctermbg=238  ctermfg=250  guibg=#444444 guifg=#bcbcbc | call s:FormatGroup('TabLine')
    highlight TabLineFill      ctermbg=238  ctermfg=250  guibg=#444444 guifg=#bcbcbc | call s:FormatGroup('TabLineFill')
    highlight TabLineSel       ctermbg=65   ctermfg=0    guibg=#5f8787 guifg=#000000 | call s:FormatGroup('TabLineSel')
    ...
    highlight Visual           ctermbg=103  ctermfg=235  guibg=#8787af guifg=#262626 | call s:FormatGroup('Visual')
